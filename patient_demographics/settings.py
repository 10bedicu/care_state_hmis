...
DEFAULTS = {
    ...
    "HMIS_EXTENSIONS_LOCATION_REQUIRED": False,
    "HMIS_EXTENSIONS_PATIENT_RELIGION_REQUIRED": False,
    "HMIS_EXTENSIONS_PATIENT_RELIGION_OPTIONS": [],
    "HMIS_EXTENSIONS_RELATED_PERSON_REQUIRED": False,
}
